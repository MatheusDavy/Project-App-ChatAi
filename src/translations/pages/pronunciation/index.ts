export const pronunciationTranslations = {
  pt: {
    pronunciation: {
      header: 'Deixe-me te ouvir',
      header_listening: 'Prossiga, Estou te ouvindo',
      inputLabel: 'Texto para referência',
  ...
  en: {
    pronunciation: {
      header: 'Let me hear you',
      header_listening: 'Go ahead, I\'m listening',
      inputLabel: 'Text for reference',
  ...
  es: {
    pronunciation: {
      header: 'Déjame escucharte',
      header_listening: 'Sigue, estoy escuchando',
      inputLabel: 'Texto de referencia',
  ...
  fr: {
    pronunciation: {
      header: 'Laissez-moi vous entendre',
      header_listening: 'Allez-y, je vous écoute',
      inputLabel: 'Texte de référence',
